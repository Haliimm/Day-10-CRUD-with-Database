...
func homePage(w http.ResponseWriter, r *http.Request) {
	...
	rows, errQuery := connection.Conn.Query(context.Background(), "SELECT id, project_name, start_date, end_date, description, technologies FROM public.tb_projects;")
	if errQuery != nil {
...
func projectPage(w http.ResponseWriter, r *http.Request) {
	...
	tmpl, err := template.ParseFiles("view/addProject.html")
	if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		w.Write([]byte("Message : " + err.Error()))
		return
...
func contactPage(w http.ResponseWriter, r *http.Request) {
	...
	tmpl, err := template.ParseFiles("view/contact-me.html")
	if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		w.Write([]byte("Message : " + err.Error()))
		return
...
func detailProject(w http.ResponseWriter, r *http.Request) {
	...
	tmpl, err := template.ParseFiles("view/detail-project.html")
	if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		w.Write([]byte("Message : " + err.Error()))
		return
